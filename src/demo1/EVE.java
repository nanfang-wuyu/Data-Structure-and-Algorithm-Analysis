...
//    private List<Dot> dots = new ArrayList<>();
    ...
    public EVE(int canvasWidth, int canvasHeight) { //.canvas:a piece of cloth
    ...
    public void update() {
       ...
       // boolean isMousePressed = StdDraw.isMousePressed();
        ...
        //for (i = 0;i < edges.size();i++){  //Edge edge : edges)

        //如果等于第三边 且有非第三边 i = 新的随机数
        ...
        for(int i = 0;i < edges.size()/2;i++){
            if(edgeList[i]!=0){
                if(i%4 == 0){
                    int t = i/4;
                    if((edgeList[i+1]!=0 && edgeList[i+12-t]!=0)||
                            (edgeList[i+12-t]!=0&& edgeList[i+15-t]!=0)||
                            (edgeList[i+1]!=0&& edgeList[i+15-t]!=0)){
                      third = true;
                    }
                }
                if(i%4 == 1){
                    ...
                    if((edgeList[i-1]!=0 && edgeList[i+11-t]!=0) ||
                            (edgeList[i-1]!=0 && edgeList[i+14-t]!=0) ||
                            (edgeList[i+14-t]!=0 && edgeList[i+11-t]!=0) ){
                        third = true;
                    }
                }
                if(i%4 == 2){
        ...
        for(int i =edges.size()/2;i < edges.size();i++ ){
            if(edgeList[i]!=0){
                if(i <= 14){
                    if((edgeList[i+3]!=0 && edgeList[i-12]!=0) &&
                            (edgeList[i-11]!=0 && edgeList[i+3]!=0) &&
                            (edgeList[i-12]!=0 && edgeList[i-11]!=0)){
                        third = true;
                    }
                }
                else if(i <= 17){//.find sequence??
                    if((edgeList[i-12+1]!=0 && edgeList[i-11+1]!=0) || (edgeList[i+3]!=0&&edgeList[i-12+1]!=0)||(edgeList[i-11+1]!=0 && edgeList[i+3]!=0)){
                        third = true;
                    }
                    if((edgeList[i-15]!=0 && edgeList[i-14]!=0) || (edgeList[i-3]!=0 && edgeList[i-15]!=0) || (edgeList[i-14]!=0 && edgeList[i-3]!=0)){
                        third = true;
                    }
                }
                else if(i <= 20){
                    if((edgeList[i-10]!=0 && edgeList[i-9]!=0) || (edgeList[i+3]!=0 && edgeList[i-10]!=0) || (edgeList[i-9]!=0 && edgeList[i+3]!=0)){
                        third = true;
                    }
                    if((edgeList[i-14]!=0 && edgeList[i-13]!=0) || (edgeList[i-3]!=0 && edgeList[i-14]!=0) || (edgeList[i-13]!=0 && edgeList[i-3]!=0)){
                        third = true;
                    }
                }
                else if(i <= 23){
                    if((edgeList[i-13]!=0 && edgeList[i-12]!=0) || (edgeList[i-3]!=0 && edgeList[i-13]!=0 )|| (edgeList[i-12]!=0 && edgeList[i-3]!=0)){
                        third = true;
                    }
                }
            }
