...
//    private List<Dot> dots = new ArrayList<>();
    ...
    private Color currentColor = Color.BLUE;//.1st.red & 2nd.blue
    ...
    public PVE330(int canvasWidth, int canvasHeight) { //.canvas:a piece of cloth
...
//      dots.forEach(Dot::paint);
        ...
        for (int i = edges.size() / 2; i < edges.size(); i++) {
            if (edgeList[i] != 0) {
                ...
                if(i <= 9 && i > 7){
                    ...
                    if (edgeList[i - 8 + t] != 0 && edgeList[i - 7 + t] != 0 && edgeList[i - 2] != 0) {
                        if (edges.get(i).time > edges.get(i - 8 + t).time && edges.get(i).time > edges.get(i - 7 + t).time && edges.get(i).time > edges.get(i - 2).time) {
                            if (edgeList[i] == 1) {
    ...
    public static void main(String[] args) {
        PVE330 game = new PVE330(800, 800);
    ...
    public static void run(int size) {
        PVE330 game = new PVE330(700, 700);
        size = 4;
